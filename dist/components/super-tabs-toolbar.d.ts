...
export declare class SuperTabsToolbar implements AfterViewInit, OnDestroy {
    ...
    setIndicatorPosition(position: number, animate?: boolean, prev?: number, now?: number, last?: number): void;
    setIndicatorWidth(width: number, animate?: boolean): void;
    setIndicatorProperties(width: number, position: number, animate?: boolean, prev?: number, now?: number, last?: number): void;
